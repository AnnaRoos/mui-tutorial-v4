...
possible. Arc Development will use that principle to provide fast, modern, inexpensive, and
aesthetic software to the Midwest and beyond.`;

export const historyText = {
  heading: 'History',
  subheading: `We’re the new kid on the block.`,
  text: [
